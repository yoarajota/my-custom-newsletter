...
// import type { User } from "@/api/search/userModel";
// import { UserRepository } from "@/api/search/userRepository";
// import { UserService } from "@/api/search/userService";

// vi.mock("@/api/search/userRepository");
